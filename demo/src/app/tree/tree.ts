    ...
    template: `
        <ng-template [ngIf]="node">
            ...
            <li *ngIf="!tree.horizontal" [ngClass]="['ui-treenode',node.styleClass||'', isLeaf() ? 'ui-treenode-leaf': '']">
                ...
                (mouseenter)="onNodeMouseover($event,node,true)" (mouseleave)="onNodeMouseover($event,node,false)"
                    ...
                    <span class="ui-tree-toggler  anticon ant-table-row-expand-icon" [ngClass]="{'ant-table-row-collapsed':!node.expanded,'ant-table-row-expanded':node.expanded}"
                    ...
                    ><div class="ui-chkbox" *ngIf="tree.selectionMode == 'checkbox'"><div class="ui-chkbox-box ui-widget ui-corner-all ui-state-default">
                        <span class="ui-chkbox-icon ui-clickable anticon" 
                            [ngClass]="{'anticon-check':isSelected() && !node.partialSelected,'anticon-minus':node.partialSelected}"></span></div></div
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="ui-treenode" [ngClass]="{'ui-treenode-collapsed':!node.expanded}">
                            <div class="ui-treenode-content ui-corner-all" [class.ui-state-default]="tree.border"  [class.ui-state-white]="!tree.border"
                            (mouseenter)="onNodeMouseover($event,node,true)" (mouseleave)="onNodeMouseover($event,node,false)"
                                [ngClass]="{'ui-treenode-selectable':tree.selectionMode,'ui-state-highlight':isSelected()}" (click)="onNodeClick($event)" (contextmenu)="onNodeRightClick($event)"
                                (touchend)="onNodeTouchEnd()">
                                <span class="ui-tree-toggler anticon anticon-fw" [ngClass]="{'anticon-plus':!node.expanded,'anticon-minus':node.expanded}" *ngIf="tree.canCollapsed && !isLeaf()"
                                        (click)="toggle($event)"></span
                                ><span [class]="getIcon()" *ngIf="node.icon||node.expandedIcon||node.collapsedIcon"></span
                                ><span class="ui-treenode-label ui-corner-all">
                                        <span *ngIf="!tree.getTemplateForNode(node)">{{node.label}}</span>
...
export class UITreeNode implements OnInit {
    ...
    static ICON_CLASS: string = 'ui-treenode-icon anticon anticon-fw';
    ...
    /**鼠标悬浮，展示编辑图标 */
    onNodeMouseover($event, node, flag) {
        node._hover = flag;
    ...
    template: `
        <div [ngClass]="{'ui-tree ui-widget ui-widget-content ui-corner-all':true,'ui-tree-selectable':selectionMode,'ui-treenode-dragover':dragHover,'ui-tree-loading': loading}" [ngStyle]="style" [class]="styleClass" *ngIf="!horizontal"
            ...
            <div class="ui-tree-loading-content" *ngIf="loading">
                <i [class]="'anticon anticon-spin anticon-2x ' + loadingIcon"></i>
            </div>
...
export class Tree implements OnInit, AfterContentInit, OnDestroy, BlockableUI {
    ...
    @Input() loadingIcon: string = 'anticon-circle-o-notch';
...
@NgModule({
    ...
    exports: [Tree, PrimeNGSharedModule],
